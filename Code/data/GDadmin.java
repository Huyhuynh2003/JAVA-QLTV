...
public class GDadmin extends JFrame {
	...
	public GDadmin() {
		...
		tabbedPane.addTab("Chat", new ImageIcon(GDadmin.class.getResource("/image/F.png")), panel_3, null);
		...
		btnNewButton.setBounds(528, 102, 277, 88);
		panel_3.add(btnNewButton);
		
		JLabel lblNewLabel_4 = new JLabel("");
		lblNewLabel_4.setIcon(new ImageIcon(GDadmin.class.getResource("/image/N.png")));
		lblNewLabel_4.setBounds(223, 65, 128, 187);
